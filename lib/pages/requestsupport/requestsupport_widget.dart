...
import 'requestsupport_model.dart';
export 'requestsupport_model.dart';
...
class _RequestsupportWidgetState extends State<RequestsupportWidget> {
  ...
  void initState() {
    ...
    _model.addressFocusNode!.addListener(() => setState(() {}));
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: const ['sanpras', 'akhil', 'ben joe'],
                      ...
                      onPressed: () async {
                        ...
                        await RequestRecord.collection
                            ...
                            .set(createRequestRecordData(
                              ...
                              phonenum: double.tryParse(
                                  _model.phoneNumberTextController.text),
                              address: _model.addressTextController.text,
                              discription:
                                  _model.descriptionTextController.text,
                              email: currentUserEmail,
                              phonnum: double.tryParse(
                                  _model.phoneNumberTextController.text),
                            ));
                        await launchUrl(Uri(
                            scheme: 'mailto',
                            path: 'sanpras2003@gmail.com',
                            query: {
                              'subject': 'help request',
                              'body':
                                  '$currentUserEmail           ${getCurrentTimestamp.toString()}${_model.descriptionTextController.text}        ${currentUserLocationValue?.toString()}',
                            }
                                .entries
